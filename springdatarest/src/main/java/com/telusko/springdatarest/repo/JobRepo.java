package com.telusko.springdatarest.repo;

import com.telusko.springdatarest.model.JobPost;
import com.telusko.springdatarest.model.JobPost;
...
/*
   ...
   return null;
    ...
    public void updateJob(JobPost jp) {
        ...
        {
            if(jobpost1.getPostId()==jp.getPostId())

            {
               jobpost1.setPostProfile(jp.getPostProfile());
               jobpost1.setPostDesc(jp.getPostDesc());
               jobpost1.setReqExperience(jp.getReqExperience());
               jobpost1.setPostTechStack(jp.getPostTechStack());
            }
